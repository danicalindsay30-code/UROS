...
DATA_DIR  = os.path.join(REPO_ROOT, '03_Data')
...
def run_pipeline(
    ...
    np.savetxt(os.path.join(DATA_DIR, "MF_input_samples.txt"), samples, fmt="%d")
    # =========================================================
    # MATCHED FILTER
    # =========================================================
    ...
    np.savetxt(os.path.join(DATA_DIR, "MF_python_model_out.txt"), python_out, fmt="%d")
